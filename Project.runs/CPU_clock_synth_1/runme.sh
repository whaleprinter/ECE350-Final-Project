...
HD_PWD='C:/Users/whale/Documents/ECE350/Vivado Projects/ece350-final-project/Project.runs/CPU_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_clock.tcl
