...
module clock_div(
    ...
    // reg [31:0] define_speed;
    // wire [7:0] fr8 = feedrate[7:0];
    // always @(*) begin 
    //     define_speed = (feedrate * 50000) >> 8;  // default is 32-bit

    //     // $display("time=%0t count=%0d new_clk=%b rst=%b", $time, count, new_clk, rst);
    // end     
    localparam define_speed = 26'd20000; // should be 50000
