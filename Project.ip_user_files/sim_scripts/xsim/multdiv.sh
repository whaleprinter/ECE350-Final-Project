...
#
# Script generated by Vivado on Mon Dec 08 13:07:06 -0500 2025
...
#
# Usage        : multdiv.sh
#                multdiv.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                multdiv.sh [-reset_run]
#                multdiv.sh [-reset_log]
#                multdiv.sh [-help]
#
...
# script info
echo -e "multdiv.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./multdiv.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot multdiv xil_defaultlib.multdiv xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim multdiv -key {Behavioral:sim_1:Functional:multdiv} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb multdiv.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./multdiv.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: multdiv.sh [-help]\n\
Usage: multdiv.sh [-step]\n\
Usage: multdiv.sh [-lib_map_path]\n\
Usage: multdiv.sh [-reset_run]\n\
Usage: multdiv.sh [-reset_log]\n\
Usage: multdiv.sh [-keep_index]\n\
Usage: multdiv.sh [-noclean_files]\n\n\
